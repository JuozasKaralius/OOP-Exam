...
namespace Codeacademy\OppExam\Repositories;

use Codeacademy\OppExam\Controllers\Validation;
use Codeacademy\OppExam\Interfaces\ElectricityRepositoryInterface;
